        ...
        <nav className="navbar">
          <section>
            <Button>
              <Link to="/mainpage">
                <p>HomePage</p>
                <HomeIcon className="navbar-logo" />
              </Link>
            </Button>
            <Button>
              <Link to="/message">
                <p>Message</p>
                <ChatBubbleIcon className="navbar-logo" />
              </Link>
            </Button>
          </section>
          <h1>
          ...
          <i className="mobile-logo fas fa-globe"></i>
          <section>
            <CreatePost
            ...
            <Button>
              <Link to="/account">
                <p>Account</p>
                <AccountCircleIcon className="navbar-logo" />
              </Link>
            </Button>
          </section>
